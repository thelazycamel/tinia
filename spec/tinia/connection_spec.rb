...
describe Tinia::Connection do
  ...
  context ".cloud_search_connection" do
    ...
    it "should get a namespaced connection" do
      ConnectionMock.cloud_search_config.stubs(:cloud_search_domain => "connection-mock")
  ...
  context ".cloud_search_domain" do
    ...
    it "should provide a setter and getter" do
      ConnectionMock.cloud_search_config.cloud_search_domain = "123"
      ConnectionMock.cloud_search_config.cloud_search_domain.should eql "123"

      ConnectionMock2 = Class.new(ConnectionMock)
      ConnectionMock2.cloud_search_config.cloud_search_domain.should eql "123"      
    end
